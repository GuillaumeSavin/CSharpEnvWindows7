...
namespace EnvWindows7
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        {
            regionSelect = (Region)listeRegion.SelectedItem;
            Application.Current.Resources["RegionSelected"] = regionSelect;
            Frame rootFrame = Window.Current.Content as Frame;
            rootFrame.Navigate(typeof(DepartementsPage));
        }
    }
}
